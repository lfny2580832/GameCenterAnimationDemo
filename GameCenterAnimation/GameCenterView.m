...
- (instancetype)init
{
    ...
    if (self) {
        ...
        [addBtn addTarget:self action:@selector(addElements) forControlEvents:UIControlEventTouchUpInside];
        [self addSubview:addBtn];
        
        UIButton *removeBtn = [[UIButton alloc]initWithFrame:CGRectMake(250, 600, 100, 40)];
